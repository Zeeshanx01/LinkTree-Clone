...
export default async function Page({ params }) {
  ...
  // const dummy = {
  //   "_id": {
  //     "$oid": "678ce9fcebc18264841ae89b"
  //   },
  //   "links": [
  //     {
  //       "link": "https://www.instagram.com/zeeshan_x01",
  //       "linktext": "Instagram"
  //     },
  //     {
  //       "link": "https://www.facebook.com/zeeshan.muneer.925?mibextid=ZbWKwL",
  //       "linktext": "Facebook"
  //     },
  //     {
  //       "link": "https://www.snapchat.com/add/zeeshan-x01",
  //       "linktext": "Snapchat"
  //     },
  //     {
  //       "link": "https://x.com/ZeeshanMunir165",
  //       "linktext": "Twitter"
  //     },
  //     {
  //       "link": "https://open.spotify.com/user/313d7xqxzwhuioyjxvd4ubmtypbu?si=GMVbeUP_Q1qd3p4XVKAGOQ&nd=1&dlsi=6c9eecc8c8894066",
  //       "linktext": "Spotify"
  //     },
  //     {
  //       "link": "https://www.threads.net/@zeeshan_x01",
  //       "linktext": "Threads"
  //     }
  //   ],
  //   "handle": "zeeshanx01",
  //   "pic": "https://avatars.githubusercontent.com/u/101858716?v=4"
  // }
  ...
  return <div
    ...
    < div className="bg-black bg-opacity-60 flex flex-col backdrop-blur-xl items-center w-full h-screen p-2">
      ...
      <div className="links w-full flex flex-col items-center justify-center ">
        {item.links.map((link, index) => {
          return <Link href={link.link} target="_blank"><div
            key={index}
            className="link overflow-hidden bg-black bg-opacity-50 p-2 m-1 rounded-sm w-[28rem] hover:w-[32rem]  hover:p-3 hover:m-0 hover:text-2xl duration-150 font-bold text-xl text-center">
            {link.linktext}
          </div></Link>
        })}
